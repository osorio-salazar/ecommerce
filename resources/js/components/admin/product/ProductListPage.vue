                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr v-for="producto in productos" :key="producto.id">
                            <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                <img :src="producto.images_product" :alt="producto.name" width="100">
                            </td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ producto.name }}</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ producto.description }}</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ producto.price }}</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">
                                <button class="bg-sky-600 text-white border-e px-3 py-2 rounded-lg p-2 mx-1">Ver</button>
                                <button class="bg-emerald-600 text-white border-e px-3 py-2 rounded-lg p-2 mx-1">Editar</button>
